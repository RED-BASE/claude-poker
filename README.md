...
**See Claude Poker in action:**

![Claude Poker Demo](demos/demo.gif)

The demo shows:
1. **Game Setup** - Configure players and chip stacks
2. **Card Capture** - Webcam captures Claude's hole cards (A♠ J♥)
3. **Strategic Decision** - Claude analyzes position, pot odds, and makes a re-raise decision with strategic banter
