...
- 🎯 **Autonom-ish Decision Making** - Claude plays for itself
...
- `mcp_capture_cards()` - Webcam capture of Claude's hole cards (kept secret... usually. good to remind claude to keep them secret)
